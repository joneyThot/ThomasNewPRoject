...
public class CompleteRequestStatusFragment extends BaseFragment implements OnClickListener, AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener{

	private static String TAG = "CompleteRequestStatusFragment";
	...
	public static Fragment newInstance(int page, String title) {
		CompleteRequestStatusFragment fragmentFirst = new CompleteRequestStatusFragment();
