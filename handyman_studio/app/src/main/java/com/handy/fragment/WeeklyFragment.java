...
public class WeeklyFragment extends BaseFragment implements OnClickListener, AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener {

    private static String TAG = "WeeklyFragment";
    ...
    public static Fragment newInstance(int page, String title) {
        WeeklyFragment fragmentFirst = new WeeklyFragment();
    ...
    private void initview() {
        ...
        if (mTempCollectionlist.size() > 0) {
            Logger.d(TAG, "SAVE Weekly Collection size :: " + mTempCollectionlist.size());
            ...
            if ((!mSharedPreferences.getString("week_total", "").isEmpty())) {
                mRootView.findViewById(R.id.total).setVisibility(View.VISIBLE);
                ((TextView) mRootView.findViewById(R.id.total)).setText("TOTAL : " + mSharedPreferences.getString("week_total", ""));
            }
        } else {
        ...
        if (collectionModelsList.size() == 0) {
            getMyCollection(mSharedPreferences.getString(Utils.USER_ID, ""), "week", String.valueOf(currentPage), lastDate);
        }
        ...
        myCollectionRequestTask.setAsyncCallListener(new AsyncCallListener() {
            ...
            public void onResponseReceived(Object response) {
                ...
                if (myCollectionModel.getSuccess().equalsIgnoreCase("1")) {
                    ...
                    Utils.storeString(mSharedPreferences, "week_total", myCollectionModel.getTotalamount());
...
//		}
    ...
    private void setView(ArrayList<MyCollectionModel> hiringAllList) {
        if (isAdded()) {
            ...
            Logger.d(TAG, "SIZE of setview Week Collection ::" + mTempCollectionlist.size());
    ...
    OnClickListener onAcceptedClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (v.getTag() != null) {
                ...
                Logger.e(TAG, "COLLECTION WEEK CLICK INDEX ::" + index);
