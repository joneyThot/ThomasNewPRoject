...
public class PendingRequestStatusFragment extends BaseFragment implements OnClickListener, AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener{

	private static String TAG = "PendingRequestStatusFragment";
	...
	public static Fragment newInstance(int page, String title) {
		PendingRequestStatusFragment fragmentFirst = new PendingRequestStatusFragment();
	...
	private void initview() {
		...
		if (mHandymanCreditsList.size() == 0) {
			if(page == 0) {
				getHandymanCredit(mSharedPreferences.getString(Utils.USER_ID, ""), "pending", String.valueOf(currentPage));
			} else if(page == 1){
				getHandymanCredit(mSharedPreferences.getString(Utils.USER_ID, ""), "accepted", String.valueOf(currentPage));
			} else if(page == 2){
				getHandymanCredit(mSharedPreferences.getString(Utils.USER_ID, ""), "completed", String.valueOf(currentPage));
			} else if(page == 3){
