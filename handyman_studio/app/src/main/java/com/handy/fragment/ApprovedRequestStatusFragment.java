...
public class ApprovedRequestStatusFragment extends BaseFragment implements OnClickListener, AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener{

	private static String TAG = "ApprovedRequestStatusFragment";
	...
	public static Fragment newInstance(int page, String title) {
		ApprovedRequestStatusFragment fragmentFirst = new ApprovedRequestStatusFragment();
