...
public class RateHandymanRequestTask extends AsyncTask<String, Integer, Object> {
	...
	private Object rate_handyman(String handyman_id, String client_id, String rate, String description) {
		...
		String getServerPath = Utils.URL_SERVER_ADDRESS + Utils.RATE_HANDYMAN;
		try {
