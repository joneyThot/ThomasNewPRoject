...
public class MyCollectionRequestTask extends AsyncTask<String, Integer, Object> {

	public static final String TAG = "MyCollectionRequestTask";
...
//	private ProgressDialog mProgressDialog;
	...
	public MyCollectionRequestTask(Context mContext) {
...
//		}
	...
	protected Object doInBackground(String... params) {
		return my_collection(params[0], params[1],params[2],params[3]);
	}
...
//		}
	...
	private Object my_collection(String handyman_id, String mode, String page, String lastDate) {
...
//          				
//                      }  else {
//								JSONObject jsonObject = data_jObj.getJSONObject(key);
//								MyCollectionModel collectionDateModel = new MyCollectionModel();
//								collectionDateModel.setDate(jsonObject.getString("date"));
////								myCollectionModelList.setDate(jsonObject.getString("date"));
//								collectionModels.add(collectionDateModel);
//								String count  = jsonObject.getString("count");
//								for (int i = 0; i < Integer.parseInt(count); i++) {
//								JSONObject all_jobj = jsonObject.getJSONObject(String.valueOf(i));
...
//			                    	collectionModel.setCompleted_date(all_jobj.getString("completed_date"));
...
//	                        	JSONObject all_jobj = jsonArray.getJSONObject(k);
	                        	...
	                        	collectionModel.setIs_outdated(all_jobj.getString("is_outdated"));
	                        	collectionModel.setAddress(all_jobj.getString("address"));
	                        	collectionModel.setFloor(all_jobj.getString("floor"));
								collectionModel.setApartment(all_jobj.getString("apartment"));
//	                        	collectionModel.setStreet(all_jobj.getString("street"));
//	                        	collectionModel.setLandmark(all_jobj.getString("landmark"));
//	                        	collectionModel.setCity(all_jobj.getString("city"));
//	                        	collectionModel.setPincode(all_jobj.getString("pincode"));
