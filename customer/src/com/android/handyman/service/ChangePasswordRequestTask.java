...
public class ChangePasswordRequestTask extends AsyncTask<String, Integer, Object> {

	public static final String TAG = "ChangePasswordRequestTask";
	...
	public ChangePasswordRequestTask(Context mContext) {
	...
	protected Object doInBackground(String... params) {
		return changepassword(params[0], params[1]);
	}
	...
	private Object changepassword(String id, String password) {
		...
		String getServerPath = Utils.URL_SERVER_ADDRESS + Utils.CHANGE_PASSWORD;
		try {
