...
import com.android.handyman.model.CheckHandymanRatingModel;
...
import com.android.handyman.service.RateHandymanRequestTask;
...
public class RatingFragment extends BaseFragment implements OnClickListener{
	...
	private void initview() {
		...
		((MainActivity) getActivity()).setTitleText("", getString(R.string.rate_handyman), View.VISIBLE, View.GONE, View.GONE,View.GONE);
...
//			getRateCheck(hire_handyman_id, mSharedPreferences.getString(Utils.USER_ID, ""));
			...
			if(Utils.validateString(hire_handyman_rating)){
