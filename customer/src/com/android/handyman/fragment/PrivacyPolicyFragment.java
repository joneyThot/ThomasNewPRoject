...
public class PrivacyPolicyFragment extends BaseFragment implements OnClickListener{
	...
	private void initview() {
		((MainActivity) getActivity()).setTitleText(getString(R.string.menu_privacy_policy), "", View.GONE, View.VISIBLE, View.GONE,View.GONE);
		...
		((WebView) mRootView.findViewById(R.id.webview)).loadUrl(Utils.URL_SERVER_ADDRESS + Utils.PRIVACY_POLICY);
