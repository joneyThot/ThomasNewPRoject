...
public class SliderPagerAdapter extends PagerAdapter {
	...
	public Object instantiateItem(ViewGroup container, final int position) {
		...
		case 0:
			((ImageView)vi.findViewById(R.id.image)).setImageResource(R.drawable.slider_1);
			((ImageView)vi.findViewById(R.id.image_new)).setVisibility(View.GONE);
			break;
			
		case 1:
			((ImageView)vi.findViewById(R.id.image)).setImageResource(R.drawable.slider_2);
			((ImageView)vi.findViewById(R.id.image_new)).setVisibility(View.GONE);
			break;
			
		case 2:
			((ImageView)vi.findViewById(R.id.image)).setImageResource(R.drawable.slider_3);
			((ImageView)vi.findViewById(R.id.image_new)).setVisibility(View.GONE);
			break;
			
		case 3:
			((ImageView)vi.findViewById(R.id.image)).setImageResource(R.drawable.slider_4);
			((ImageView)vi.findViewById(R.id.image_new)).setVisibility(View.GONE);
			break;
			
		case 4:
			((ImageView)vi.findViewById(R.id.image)).setImageResource(R.drawable.slider_5);
			((ImageView)vi.findViewById(R.id.image_new)).setVisibility(View.GONE);
			break;
