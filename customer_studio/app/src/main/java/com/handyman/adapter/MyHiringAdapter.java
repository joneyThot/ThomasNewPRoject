...
public class MyHiringAdapter extends BaseAdapter {
    ...
    private ArrayList<MyHiringsModel> mMyHiringsList = new ArrayList<>();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (position < mMyHiringsList.size()) {
//			Logger.e("adapter","Pos :: " + position);
            if (Utils.validateString(mMyHiringsList.get(position).hire_status)) {
                status = mMyHiringsList.get(position).hire_status;
...
//
            ...
            if (status.equalsIgnoreCase("completed")) {
                if (Utils.validateString(mMyHiringsList.get(position).credit)) {
//                    ((TextView) vi.findViewById(R.id.credits_text)).setText(mMyHiringsList.get(position).credit + " Coins Used     ");
                    ((TextView) vi.findViewById(R.id.credits_text)).setText(mMyHiringsList.get(position).credit + " Coins Charged ");
                }
                ...
                if (Utils.validateString(mMyHiringsList.get(position).debit)) {
                    if (status.equalsIgnoreCase("cancelled") && mMyHiringsList.get(position).after_time_limit_cancel.equalsIgnoreCase("1")) {
                        ((TextView) vi.findViewById(R.id.credits_text)).setText(mMyHiringsList.get(position).debit + " Coins Deducted");
                    } else {
                        ((TextView) vi.findViewById(R.id.credits_text)).setText(mMyHiringsList.get(position).debit + " Coins Reverted");
                    }
                }
            } else {
                if (Utils.validateString(mMyHiringsList.get(position).debit)) {
                    ((TextView) vi.findViewById(R.id.credits_text)).setText(mMyHiringsList.get(position).debit + " Coins Charged ");
                }
            }
