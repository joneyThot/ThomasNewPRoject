...
public class HireOTPRequestTask extends AsyncTask<String, Integer, Object> {

    public static final String TAG = "HireOTPRequestTask";
    ...
    public HireOTPRequestTask(Context mContext) {
    ...
    private Object otpCode(String users_id, String contact_no, String order_id) {
        ...
        String getServerPath = Utils.URL_SERVER_ADDRESS + Utils.HIRE_OTP;
        try {
