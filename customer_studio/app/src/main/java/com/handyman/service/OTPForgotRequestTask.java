...
public class OTPForgotRequestTask extends AsyncTask<String, Integer, Object> {

	public static final String TAG = "OTPForgotRequestTask";
	...
	public OTPForgotRequestTask(Context mContext) {
	...
	private Object otpCode(String userId, String mobile, String otp) {
		...
		String getServerPath = Utils.URL_SERVER_ADDRESS + Utils.OTP_FORGOT;
		try {
