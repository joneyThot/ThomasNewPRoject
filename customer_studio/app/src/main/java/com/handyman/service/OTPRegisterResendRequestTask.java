...
public class OTPRegisterResendRequestTask extends AsyncTask<String, Integer, Object> {

    public static final String TAG = "OTPRegisterResendRequestTask";
...
//    private ProgressDialog mProgressDialog;
    ...
    public OTPRegisterResendRequestTask(Context mContext) {
...
//        }
    ...
    private Object otpCode(String id, String mobile) {
        ...
        String getServerPath = Utils.URL_SERVER_ADDRESS + Utils.OTP_RESEND_REGISTER;
        try {
