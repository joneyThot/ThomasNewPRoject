...
//	HandymanHiringAdapter handymanHiringAdapter = null;
    ...
    boolean flag = false/*, isScrolling = false*/;
	...
	private void initview() {
		...
		/*myhiringlist.setOnTouchListener(new View.OnTouchListener() {
			@Override
	...
	OnClickListener onAcceptedClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			if(v.getTag() != null){
				...
				if(index < mTempCustomerList.size()){
...
//				isScrolling = false;
//				Logger.e(TAG,"SCROLL_STATE_TOUCH_SCROLL :: " + isScrolling);
//				break;
//			case SCROLL_STATE_IDLE:
//				isScrolling = false;
//				Logger.e(TAG,"SCROLL_STATE_IDLE :: " + isScrolling);
//				break;
//			case SCROLL_STATE_FLING:
//				isScrolling = true;
//				Logger.e(TAG,"SCROLL_STATE_FLING :: " + isScrolling);
//				break;
		}
	}
