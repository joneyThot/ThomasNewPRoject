...
public class DataModel implements Serializable {
	...
	@SerializedName("data")
	public ArrayList<CityModel> cityModels = new ArrayList<CityModel>();
	
	@SerializedName("data")
	public ArrayList<TimeIntervalModel> timeIntervalModels = new ArrayList<TimeIntervalModel>();
	...
	public ArrayList<TimeIntervalModel> getTimeIntervalModels() {
		return timeIntervalModels;
	}

	public void setTimeIntervalModels(ArrayList<TimeIntervalModel> timeIntervalModels) {
		this.timeIntervalModels = timeIntervalModels;
	}
