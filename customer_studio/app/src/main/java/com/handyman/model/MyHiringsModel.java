...
//	public String state = "";
	...
	@SerializedName("h_lng")
	public String h_lng = "";

	@SerializedName("user_like")
	public String user_like = "";

	@SerializedName("handyman_rate")
	public String handyman_rate = "";

	@SerializedName("after_time_limit_cancel")
	public String after_time_limit_cancel = "";
...
//	}
	...
	public String getHandyman_rate() {
		return handyman_rate;
	}

	public void setHandyman_rate(String handyman_rate) {
		this.handyman_rate = handyman_rate;
	}

	public String getAfter_time_limit_cancel() {
		return after_time_limit_cancel;
	}

	public void setAfter_time_limit_cancel(String after_time_limit_cancel) {
		this.after_time_limit_cancel = after_time_limit_cancel;
	}
}
