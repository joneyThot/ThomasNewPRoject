...
public class ProfileHandymanModel implements Serializable {
	...
	@SerializedName("handyman_busy")
	public String handyman_busy = "";
	...
	public String getHandyman_busy() {
		return handyman_busy;
	}

	public void setHandyman_busy(String handyman_busy) {
		this.handyman_busy = handyman_busy;
	}
