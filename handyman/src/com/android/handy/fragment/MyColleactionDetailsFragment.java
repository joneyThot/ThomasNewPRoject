		...
		if(getArguments() != null) {
			...
			if(mDayCollection != null){
				...
				if(Utils.validateString(mDayCollection.order_id)){
					mRootView.findViewById(R.id.my_collection_details_order_id_for_textview).setVisibility(View.VISIBLE);
					mRootView.findViewById(R.id.my_collection_details_order_id_for_txt).setVisibility(View.VISIBLE);
				...
				if(Utils.validateString(mDayCollection.created_date)){
					mRootView.findViewById(R.id.my_collection_details_order_date_textview).setVisibility(View.VISIBLE);
					mRootView.findViewById(R.id.my_collection_details_order_date_text).setVisibility(View.VISIBLE);
				...
				if(Utils.validateString(mDayCollection.amount)){
					mRootView.findViewById(R.id.my_collection_details_amount_txt_textview).setVisibility(View.VISIBLE);
				...
				if(Utils.validateString(mDayCollection.discount)){
					mRootView.findViewById(R.id.my_collection_details_discount_txt_textview).setVisibility(View.VISIBLE);
					mRootView.findViewById(R.id.my_collection_details_discount_txt).setVisibility(View.VISIBLE);
				...
				if(Utils.validateString(mDayCollection.credit)){
					mRootView.findViewById(R.id.my_collection_details_credit_txt_textview).setVisibility(View.VISIBLE);
					mRootView.findViewById(R.id.my_collection_details_credit_txt).setVisibility(View.VISIBLE);
