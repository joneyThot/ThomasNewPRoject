...
public class HandymanCustomerHireProfileFragment extends BaseFragment implements OnClickListener{
	...
	String client_email = "", client_name = "",job_id = "",category_id, status, status_id,latitude = "0.0",longitude = "0.0", h_name = "", h_email = "",job_Description = "", mobile_no = "", full_address = "";
		...
		if(getArguments() != null) {
			...
			if(mPendingHirings != null){
				...
				if(Utils.validateString(mPendingHirings.getAddress())){
					...
					if(Utils.validateString(mPendingHirings.getCity()))
						city = mPendingHirings.getCity();
					if(Utils.validateString(mPendingHirings.getState()))
						state = mPendingHirings.getState();
			...
			if(mAcceptedHirings != null){
				...
				if(Utils.validateString(mAcceptedHirings.getAddress())){
					...
					if(Utils.validateString(mAcceptedHirings.getCity()))
						city = mAcceptedHirings.getCity();
					if(Utils.validateString(mAcceptedHirings.getState()))
						state = mAcceptedHirings.getState();
			...
			if(mStartingHirings != null){
				...
				if(Utils.validateString(mStartingHirings.getAddress())){
					...
					if(Utils.validateString(mStartingHirings.getCity()))
						city = mStartingHirings.getCity();
					if(Utils.validateString(mStartingHirings.getState()))
						state = mStartingHirings.getState();
			...
			if(mCancelHirings != null){
				...
				if(Utils.validateString(mCancelHirings.getAddress())){
					...
					if(Utils.validateString(mCancelHirings.getCity()))
						city = mCancelHirings.getCity();
					if(Utils.validateString(mCancelHirings.getState()))
						state = mCancelHirings.getState();
			...
			if(mCompleteHirings != null){
				...
				if(Utils.validateString(mCompleteHirings.getAddress())){
					...
					if(Utils.validateString(mCompleteHirings.getCity()))
						city = mCompleteHirings.getCity();
					if(Utils.validateString(mCompleteHirings.getState()))
						state = mCompleteHirings.getState();
			...
			if(mRejectedHirings != null){
				...
				if(Utils.validateString(mRejectedHirings.getAddress())){
					...
					if(Utils.validateString(mRejectedHirings.getCity()))
						city = mRejectedHirings.getCity();
					if(Utils.validateString(mRejectedHirings.getState()))
						state = mRejectedHirings.getState();
			...
			if(mAllHirings != null){
				...
				if(Utils.validateString(mAllHirings.getAddress())){
					...
					if(Utils.validateString(mAllHirings.getCity()))
						city = mAllHirings.getCity();
					if(Utils.validateString(mAllHirings.getState()))
						state = mAllHirings.getState();
