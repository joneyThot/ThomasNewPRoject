...
import com.android.handy.service.GetContackSupportRequestTask;
...
public class ContactSupportFragment extends BaseFragment implements OnClickListener{
	...
	private void initview() {
		((MainActivity) getActivity()).setTitleText(getString(R.string.menu_contact_support), "", View.GONE, View.VISIBLE, View.GONE);
