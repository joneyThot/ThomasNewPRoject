...
import com.android.handy.adapter.ReviewAdapter;
...
import com.android.handy.service.GetMyProfileRequestListTask;
import com.android.handy.service.GetReviewListRequestTask;
import com.android.handy.service.Utils;
import com.android.handy.view.ExpandedListView;
...
public class MyProfileFragment extends BaseFragment implements OnClickListener{
	...
	private void initview() {
		...
		((MainActivity) getActivity()).setTitleText(getString(R.string.menu_my_profile), "", View.GONE, View.VISIBLE, View.GONE);
