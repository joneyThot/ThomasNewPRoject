...
import com.android.handy.LoginActivity;
import com.android.handy.MainActivity;
import com.android.handy.MyServiceBack;
import com.android.handy.R;
import com.android.handy.ServiceTest;
...
import com.android.handy.service.LogoutRequestTask;
...
//		for (int i = 1; i < mMenuLayout.getChildCount(); i++) {
//				((LinearLayout) mMenuLayout.getChildAt(i)).setBackgroundResource(R.drawable.hover_btn_xxxhdpi);
//		}
//		
//		
//		((LinearLayout) view).setBackgroundResource(R.drawable.hover_btn_xxxhdpi);
		...
		case R.id.menu_my_hirings_layout:
			...
			((LinearLayout) mRoot.findViewById(R.id.menu_my_collection_layout)).setBackgroundResource(android.R.color.transparent);
			((LinearLayout) mRoot.findViewById(R.id.menu_my_review_layout)).setBackgroundResource(android.R.color.transparent);
		...
		case R.id.menu_my_collection_layout:
			...
			((LinearLayout) mRoot.findViewById(R.id.menu_my_hirings_layout)).setBackgroundResource(android.R.color.transparent);
			((LinearLayout) mRoot.findViewById(R.id.menu_my_profile_layout)).setBackgroundResource(android.R.color.transparent);
			((LinearLayout) mRoot.findViewById(R.id.menu_my_collection_layout)).setBackgroundResource(R.color.light_red);
			((LinearLayout) mRoot.findViewById(R.id.menu_my_review_layout)).setBackgroundResource(android.R.color.transparent);
			((LinearLayout) mRoot.findViewById(R.id.menu_feedback_suggestions_layout)).setBackgroundResource(android.R.color.transparent);
			((LinearLayout) mRoot.findViewById(R.id.menu_about_service_at_home_layout)).setBackgroundResource(android.R.color.transparent);
			((LinearLayout) mRoot.findViewById(R.id.menu_contact_support_layout)).setBackgroundResource(android.R.color.transparent);
		...
		case R.id.menu_my_review_layout:
			...
			((LinearLayout) mRoot.findViewById(R.id.menu_my_profile_layout)).setBackgroundResource(android.R.color.transparent);
			((LinearLayout) mRoot.findViewById(R.id.menu_my_collection_layout)).setBackgroundResource(android.R.color.transparent);
			((LinearLayout) mRoot.findViewById(R.id.menu_my_review_layout)).setBackgroundResource(R.color.light_red);
			((LinearLayout) mRoot.findViewById(R.id.menu_feedback_suggestions_layout)).setBackgroundResource(android.R.color.transparent);
			((LinearLayout) mRoot.findViewById(R.id.menu_about_service_at_home_layout)).setBackgroundResource(android.R.color.transparent);
			((LinearLayout) mRoot.findViewById(R.id.menu_contact_support_layout)).setBackgroundResource(android.R.color.transparent);
			((LinearLayout) mRoot.findViewById(R.id.menu_privacy_policy_layout)).setBackgroundResource(android.R.color.transparent);
...
//			startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=app.demohandymanpartner")));
        	...
        	logoutRequestTask.setAsyncCallListener(new AsyncCallListener() {
                ...
                public void onResponseReceived(Object response) {
                    ...
                    if(registerModel.success.equalsIgnoreCase("1")) {
						...
						getActivity().stopService(new Intent(getActivity(), ServiceTest.class));
