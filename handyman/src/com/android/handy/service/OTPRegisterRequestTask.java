...
public class OTPRegisterRequestTask extends AsyncTask<String, Integer, Object> {

	public static final String TAG = "OTPRegisterRequestTask";
	...
	public OTPRegisterRequestTask(Context mContext) {
	...
	private Object otpCode(String mobile, String otp) {
		...
		String getServerPath = Utils.URL_SERVER_ADDRESS + Utils.OTP_CODECHECK_REGISTER;
		try {
