...
import com.android.handy.model.CreditsModel;
import com.google.gson.Gson;

public class CustomerConfirmRequestTask extends AsyncTask<String, Integer, Object> {

	public static final String TAG = "CustomerConfirmRequestTask";
	...
	public CustomerConfirmRequestTask(Context mContext) {
	...
	private Object getCustomerCredits(String id) {
		...
		String getServerPath = Utils.URL_SERVER_ADDRESS + Utils.CUSTOMER_CONFIRM_CREDIT;
		try {
